...
function DropDown({ setFilters }: { setFilters: (param: any) => void }) {
    ...
    return (
        <>
            <div className="grid xs:w-full lg:w-3/5 mt-4 pt-4">
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mx-3">
                        ...
                        {!!pop && (
                            <ul className="dropdown-content w-40 sm:w-40 md:w-48 lg:w-48 xl:w-56">
                                ...
                                <li
                                    ...
                                    onClick={() => handleSelection(setPop, setOrder, { text: "Descending", value: "desc" })}
                                >
                                    Descending
                                </li>
                            </ul>
                    ...
                    <div className="w-full pb-2 col-span-1">
                        ...
                        {!!showType && (
                            <ul className="dropdown-content w-40 sm:w-40 md:w-48 lg:w-48 xl:w-56">
                                <li className="dropdown-item" onClick={() => handleSelection(setShowType, setType, { text: "All", value: "all" })}>
                                    All
                                </li>
                                <li
                                    className="dropdown-item"
                                    onClick={() => handleSelection(setShowType, setType, { text: "Image", value: "image" })}
                                >
                                    Image
                                </li>
                                <li
                                    className="dropdown-item"
                                    onClick={() => handleSelection(setShowType, setType, { text: "Audio", value: "audio" })}
                                >
                                    Audio
                                </li>
                                <li
                                    className="dropdown-item"
                                    onClick={() => handleSelection(setShowType, setType, { text: "Video", value: "video" })}
                                >
                                    Video
                                </li>
                    ...
                    <div className="w-full pb-2 col-span-1">
                        ...
                        {!!showRange && (
                            <ul className="dropdown-content w-40 sm:w-40 md:w-48 lg:w-48 xl:w-56">
                                <li className="dropdown-item" onClick={() => handleSelection(setShowRange, setRange, { text: "All", value: "all" })}>
                                    All
                                </li>
                                <li
                                    className="dropdown-item"
                                    onClick={() => handleSelection(setShowRange, setRange, { text: "1 - 5", value: "1-5" })}
                                >
                                    1-5 Near
                                </li>
                                <li
                                    className="dropdown-item"
                                    onClick={() => handleSelection(setShowRange, setRange, { text: "5 - 10", value: "5-10" })}
                                >
                                    5-10 Near
                                </li>
                                <li
                                    className="dropdown-item"
                                    onClick={() => handleSelection(setShowRange, setRange, { text: "10- 100", value: "10-100" })}
                                >
                                    10-100 Near
                                </li>
                                <li
                                    className="dropdown-item"
                                    onClick={() => handleSelection(setShowRange, setRange, { text: "100+", value: "100+" })}
                                >
                                    {" "}
                                    100 Near &gt;
                                </li>
