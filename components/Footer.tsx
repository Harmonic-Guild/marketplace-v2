        ...
        <footer className="w-full max-w-screen-2xl mx-auto px-6 py-10 text-gray-700 mt-20">
            ...
            <div className="flex flex-wrap justify-between p-10 gap-8">
                ...
                <div className="lg:text-xl text-sm">
                    <span className="font-bold headerFont">LEARN MORE</span>
                    <ul className="leading-loose capitalize text-font">
                        <li>About</li>
                        <li>Merchant</li>
                        <li>Partners</li>
                        <li>Contact</li>
                ...
                <div className="lg:text-xl text-sm">
                    <span className="font-bold headerFont">LEGAL</span>
                    <ul className="leading-loose capitalize text-font">
                        <li>General Info</li>
                ...
                <div className="lg:text-xl text-sm">
                    <span className="font-bold headerFont">TALK TO US</span>
                    <ul className="leading-loose capitalize text-font">
                        <li>Contact us</li>
                        <li>Facebook</li>
                        <li>LinkedIn</li>
