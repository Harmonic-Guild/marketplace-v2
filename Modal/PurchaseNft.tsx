...
const PurchaseNft = ({ buy, price, isConnected }: { buy: any; price: string; isConnected: boolean }) => {
    return (
        <div className="flex flex-col lg:flex-row lg:justify-between items-center  border border-bd-color bg-bg-color rounded-lg w-full tokenPriceNumber px-6 py-6 mt-10">
